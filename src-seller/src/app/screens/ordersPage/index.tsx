...
export function OrdersPage() {
  ...
  const filteredOrders = useMemo(() => {
    ...
    return orders.filter((order) =>
      [order.id, order.deliveryStatus, order.paymentStatus, ...order.items.map((item) => item.name)]
        .join(" ")
        .toLowerCase()
